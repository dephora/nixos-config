...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Matt Davis"
    user-mail-address "matthew.davis@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bit/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bit/bin" "/profile/bin" "/Users/bit/.npm-packages/bin" "/Users/bit/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
